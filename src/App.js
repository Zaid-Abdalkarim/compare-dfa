...
const App = () => {
  ...
  const handleCompareClick_WithEquivalenceChecker= () => {
    ...
    let dfaReader1 = new DFAReader(dfaOneToDomainObject);
    let dfa1 = dfaReader1.createDFA();
    dfa1.printStates();
    DFAReader.printDFA(dfa1);

    let dfaReader2 = new DFAReader(dfaTwoToDomainObject);
